(function () {
    // 创建并放置新的节点
    var link = document.querySelector('a'); //document.querySelector允许使用CSS选择器来选择元素
    link.textContent = 'Mozilla Developer Network'; // 赋予文本
    link.href = 'https://developer.mozilla.org'; // 赋予属性值
    var sect = document.querySelector('section'); // 选择到section元素
    var para = document.createElement('p'); // 创建一个新元素p
